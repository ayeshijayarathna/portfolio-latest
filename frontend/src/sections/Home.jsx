    ...
    <section id="home" style={{
      ...
      <div style={{ flex: 1, zIndex: 1, paddingTop: '80px', paddingBottom: '40px' }}>
        <h1 style={{
          ...
          color: '#b47c7c', marginBottom: '8px', lineHeight: 1.1, fontWeight: 400,
        }}>
          {profile.name}
        </h1>
        ...
        <p style={{
          fontFamily: 'var(--font-sans)', fontSize: '0.93rem', fontWeight: 300, lineHeight: 1.8,
        ...
        <p style={{
          ...
          letterSpacing: '0.25em', textTransform: 'uppercase', color: '#c9a882',
          marginBottom: '44px', minHeight: '20px',
        }}>
          {displayed}
          <span style={{
            display: 'inline-block', width: '1.5px', height: '0.85em',
            backgroundColor: '#c9a882', marginLeft: '2px', verticalAlign: 'middle',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '28px', flexWrap: 'wrap', marginBottom: '44px' }}>
          <button
            ...
            style={{
              display: 'flex', alignItems: 'center', gap: '8px', padding: '13px 30px',
              border: isDark ? '1px solid rgba(232,224,213,0.35)' : '1px solid #2c2c2c',
              background: 'transparent', color: isDark ? '#e8e0d5' : '#2c2c2c',
              fontFamily: 'var(--font-sans)', fontSize: '0.68rem', fontWeight: 500,
              letterSpacing: '0.18em', textTransform: 'uppercase', cursor: 'pointer', transition: 'all 0.3s ease',
            }}
          ...
          <button
            ...
            style={{
              ...
              fontSize: '0.68rem', fontWeight: 500, letterSpacing: '0.18em', textTransform: 'uppercase',
              color: isDark ? 'rgba(232,224,213,0.5)' : 'rgba(44,44,44,0.55)', cursor: 'pointer', transition: 'color 0.3s ease',
            }}
        ...
        <div style={{ display: 'flex', gap: '14px', alignItems: 'center' }}>
          {[
            { icon: <BsLinkedin size={15} />, href: profile.linkedin },
            { icon: <BsGithub size={15} />, href: profile.github },
            { icon: <MdEmail size={17} />, href: `mailto:${profile.email}` },
          ].map((item, i) => (
      ...
      <div style={{
        ...
        position: 'relative', zIndex: 1, height: '100vh', maxHeight: '100vh',
      }}>
        <p style={{
          position: 'absolute', bottom: '48px', right: '20px',
          fontFamily: 'var(--font-script)', fontSize: '1.5rem',
          color: isDark ? 'rgba(212,164,154,0.35)' : 'rgba(180,124,124,0.3)', zIndex: 0,
        }}>
          est. {profile.estYear}
        </p>
        <img src={profile.heroImage ? `http://localhost:5000${profile.heroImage}` : "/avatar.jpg"} alt={profile.name}
          style={{
            height: '88vh', width: 'auto', maxWidth: '100%', objectFit: 'cover',
            objectPosition: 'top center', display: 'block',
            filter: isDark ? 'brightness(0.85)' : 'none', position: 'relative', zIndex: 1,
          }}
        />
      </div>
      ...
      <style>{`
        ...
        @media (max-width: 900px) {
          #home { flex-direction: column !important; padding-top: 100px !important; align-items: flex-start !important; }
          #home > div:last-child { height: 400px !important; width: 100% !important; justify-content: center !important; }
          #home > div:last-child img { height: 400px !important; }
        }
      `}</style>
    </section>
  )
