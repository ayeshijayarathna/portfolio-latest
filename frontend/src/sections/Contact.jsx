...
const socialLinks = [
  { icon: <BsLinkedin size={18} />, label: 'LinkedIn', href: 'https://linkedin.com/in/ayeshi', value: 'linkedin.com/in/ayeshi' },
  { icon: <BsGithub size={18} />, label: 'GitHub', href: 'https://github.com/ayeshi', value: 'github.com/ayeshi' },
  { icon: <MdEmail size={20} />, label: 'Email', href: 'mailto:ayeshi@email.com', value: 'ayeshi@email.com' },
  { icon: <FiMapPin size={18} />, label: 'Location', href: null, value: 'Kandy, Sri Lanka' },
]
    ...
    <section id="contact" style={{
      ...
      <div style={{ marginBottom: '64px' }}>
        <h2 style={{
          ...
          Let's
          <span style={{ fontStyle: 'italic', color: '#b47c7c' }}> Connect</span>
        </h2>
            ...
            {socialLinks.map((link, i) => (
              ...
              >
                <div style={{
                  ...
                  height: '40px',
                  borderRadius: '50%',
                  backgroundColor: 'rgba(180,124,124,0.12)',
                  display: 'flex',
                  alignItems: 'center',
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <button
              ...
              onMouseEnter={e => {
                if (status !== 'loading') e.currentTarget.style.backgroundColor = '#9d6868'
              }}
              onMouseLeave={e => {
                if (status !== 'loading' && status !== 'success') e.currentTarget.style.backgroundColor = '#b47c7c'
              }}
            >
              {status === 'loading' ? (
                <>Sending...</>
      ...
      <div style={{
        ...
        <p style={{
          ...
          © 2024 Ayeshi I. Jayarathna. All rights reserved.
        </p>
      </div>
