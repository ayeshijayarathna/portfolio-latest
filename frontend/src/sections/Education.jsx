...
function TimelineItem({ item, index, isDark, isLast }) {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div style={{ flex: 1, paddingBottom: !isLast ? '48px' : '0' }}>
        ...
        <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.88rem', fontWeight: 300, lineHeight: 1.75, color: muted, maxWidth: '560px', marginBottom: '16px' }}>
          {item.description}
        </p>
        {tags.length > 0 && (
